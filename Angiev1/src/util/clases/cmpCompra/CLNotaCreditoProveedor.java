 ...
 * @author Luis Morales
 */
public class CLNotaCreditoProveedor
{
...
private JLabel LblMontoPercepcion;
   ...
   public CLNotaCreditoProveedor(JTable oTabla,JLabel LblSubTotalSinIgvNuevo,
        ...
        float ImporNuevo=0;
         float cantidadNueva=0;
            if(oTabla.getValueAt(fil, colCantDevuelta)!=null){
                cantidadNueva=Float.parseFloat(oTabla.getValueAt(fil, colCantDevuelta).toString());
            }

         if(col==colPrecioNuevo)
            {
            if(oTabla.getValueAt(fil, colPrecioNuevo)!=null){
                precioNuevo=Float.parseFloat(oTabla.getValueAt(fil, colPrecioNuevo).toString());
            }
...
public void CalcularCeldaImporteNuevoPorCant(int fil,int col)
    {
