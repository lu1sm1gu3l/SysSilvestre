...
public class DlgBusquedaGuiaRemisionRecibido extends DialogoPadre
{

    private List<CEGuiaRemisionRecibido> oListaGuiaRemisionRecibido;
    private java.awt.Frame oparent;
    private boolean cargar;
    public DlgBusquedaGuiaRemisionRecibido(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        cargar=false;
        ...
        CbxEstado.setModel(CLComboBox.cargarCombo(CCEstado.ListadoEstadoGuiaRemision()));
        this.oparent=parent;
        cargar=true;
    ...
    private void initComponents() {
        ...
        setTitle("Busqueda Guia Remisión Recibido");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(chkFecha, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(DtChFecha, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(chkFecha1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
 ...
 boolean iscerrando=false;
    ...
    {
    limpiarTabla();
         for(CEGuiaRemisionRecibido vCEGuiaRemisionRecibido:oListaGuiaRemisionRecibido )
                {
                    if(vCEGuiaRemisionRecibido.toString().contains(TxtCliente.getText().toUpperCase()))
                    {
                         ArrayList oArrayList=new ArrayList();
                        oArrayList.add(vCEGuiaRemisionRecibido.getFecha());
                        oArrayList.add(vCEGuiaRemisionRecibido.getNumeroDocumento());
                        oArrayList.add(vCEGuiaRemisionRecibido);
                        oArrayList.add(vCEGuiaRemisionRecibido.getUltimoEstado());
...
public CEGuiaRemisionRecibido getCEGuiaRemisionRecibido()
{
...
private void SelecionarRegistro()
    {
        ...
        if(filSel!=-1){
        oCEGuiaRemisionRecibido=(CEGuiaRemisionRecibido)TblDato.getValueAt(filSel, 2);
        dispose();
        }else
        {
    ...
    private List<CEGuiaRemisionRecibido> listarRegistros()
    {
...
//        {
//            return CCGuiaRemisionRecibido.BuscarGuiaRemisionRecibido(3, dato,1);
//        }
        if(tbBusqueda.getSelectedIndex()==1){
            return CCGuiaRemisionRecibido.BuscarPorCodigo(dato);
                }
        ...
        if(tbBusqueda.getSelectedIndex()==2){
            ...
            if(id_proveedor!=-1)
            {
                return CCGuiaRemisionRecibido.BuscarPorProveedor(id_proveedor);
            }
        }
        ...
        if(tbBusqueda.getSelectedIndex()==0)
        {
           ...
           return CCGuiaRemisionRecibido.BusqAvanzadaIngreso(pFecha,id_Estado,pFechaFin);
            }
        }
        return null;
    ...
    {
        oListaGuiaRemisionRecibido=listarRegistros();
       limpiarTabla();
       if(oListaGuiaRemisionRecibido!=null)
       {

                for(CEGuiaRemisionRecibido pCEGuiaRemisionRecibido:oListaGuiaRemisionRecibido )
                {
                        ArrayList oArrayList=new ArrayList();
                        oArrayList.add(pCEGuiaRemisionRecibido.getFecha());
                        oArrayList.add(pCEGuiaRemisionRecibido.getNumeroDocumento());
                        oArrayList.add(pCEGuiaRemisionRecibido);
                        oArrayList.add(pCEGuiaRemisionRecibido.getUltimoEstado());
                        ((ArrayListTableModel)TblDato.getModel()).addRow(oArrayList);
