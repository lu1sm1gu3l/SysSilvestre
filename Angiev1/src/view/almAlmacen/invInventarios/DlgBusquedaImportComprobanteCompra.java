...
public class DlgBusquedaImportComprobanteCompra extends DialogoPadre
{

    private List<CEComprobanteCompraMatriz> oListaComprobanteCompra;
    private java.awt.Frame oparent;
    private boolean cargar;
    public DlgBusquedaImportComprobanteCompra(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        cargar=false;
    ...
    private void configurarTabla()
    {
        ...
        oTableColumnModel.getColumn(0).setPreferredWidth(110);
        ...
        oTableColumnModel.getColumn(5).setPreferredWidth(90);
        oTableColumnModel.getColumn(6).setPreferredWidth(110);
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(chkFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(chkFecha1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(DtChFechaFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(LblEstado, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(CbxEstado, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE))
                .addGap(27, 27, 27)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(DtChFechaFinal, javax.swing.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(tbBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 840, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(tbBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
private void SelecionarRegistro()
    {
        ...
        oCEComprobanteCompraMatriz=(CEComprobanteCompraMatriz)TblDato.getValueAt(filSel, 2);
            if(oCEComprobanteCompraMatriz.getIdEstadoInventario()!=8){
            dispose();
            }
            else
            {
            JOptionPane.showMessageDialog(null, "No se puede seleccionar el Comprobante ya fue "+oCEComprobanteCompraMatriz.getEstadoInventario(), "Mensaje de Error", JOptionPane.ERROR_MESSAGE);
            oCEComprobanteCompraMatriz=null;
            }
        }
        else
        {
    ...
    private List<CEComprobanteCompraMatriz> listarRegistros()
    {
        ...
        if(tbBusqueda.getSelectedIndex()==0)
        {
           ...
           return CCComprobanteCompra.BusqAvanzadaCompra(pFecha,0,id_TipoComp,id_Estado,pFechaFin,false);
            }
        }
        return null;
