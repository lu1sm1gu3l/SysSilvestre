...
public class DlgReporteListadoStockProductos extends DialogoPadre
{
    int idProveedor=0;
 
    public DlgReporteListadoStockProductos(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String url)
    ...
    ClaseReporte_Parametro oClaseParametroIdProv = new ClaseReporte_Parametro();
    oClaseParametroIdProv.setNombre("pidproveedor");
    oClaseParametroIdProv.setPParametro(""+idProveedor);
    ...
    oLstParametro.add(oClaseParametroIdProv);
...
private int obtenerOpcion()
    ...
    private void initComponents() {
        ...
        setTitle("Reporte Stock de Productos");
        ...
        RbnTodos.setFont(new java.awt.Font("Verdana", 1, 11)); // NOI18N
    ...
    private void BtnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGenerarActionPerformed
        ...
        RbnTodos.setEnabled(false);
        RbnUnidadBase.setEnabled(false);
        ChkProv.setEnabled(false);
        ...
        Runnable miRunnable = new Runnable() {
            public void run() {
                try {
                        ...
                        reportar("/view/almAlmacen/rptALMReportes/ALMRPTInventariodeAlmacen.jasper");
                    ...
                    RbnTodos.setEnabled(true);
                    RbnUnidadBase.setEnabled(true);
                    ChkProv.setEnabled(true);
                    TxtProveedor1.setEditable(true);
