...
public class DlgAnularOrdenCompra extends DialogoPadre
{

    CEOrdenCompraMatriz oCEOrdenCompraMatriz;
    public DlgAnularOrdenCompra(java.awt.Frame parent, boolean modal,CEOrdenCompraMatriz oCEOrdenCompraMatriz)
    {
        super(parent, modal);
        initComponents();
        this.oCEOrdenCompraMatriz=oCEOrdenCompraMatriz;
        TxtCliente.setText(oCEOrdenCompraMatriz.getProveedor()+"");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Anular Orden Compra");
    ...
    private void BtnAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAnularActionPerformed
     ...
     oCEOrdenCompraMatriz.setObservacion(TxObservacion);
     if(CCOrdenCompra.AnularOrdenCompra(oCEOrdenCompraMatriz)==1)
     {
        dispose();
     }
    else
