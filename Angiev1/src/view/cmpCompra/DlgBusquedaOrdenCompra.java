...
public class DlgBusquedaOrdenCompra extends DialogoPadre implements ActionListener
{

    private List<CEOrdenCompraMatriz> oListaOrdenCompra;
    private java.awt.Frame oparent;
    private boolean cargar;
    public DlgBusquedaOrdenCompra(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        cargar=false;
  ...
  ;
    ...
    private void initComponents() {
        ...
        setTitle("Busqueda Orden Compra");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblTipocomp, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(CbxEstado, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
                    .addComponent(CbxTipoComp, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btnBuscar2.setText("Buscar Serie");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            .addGap(10, 10, 10)
                            .addComponent(tbBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 769, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(11, 11, 11)
                            .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, 163, Short.MAX_VALUE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tbBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(36, 36, 36)
 ...
 boolean iscerrando=false;
    ...
    {
    limpiarTabla();
         for(CEOrdenCompraMatriz oCEOrdenCompraMatriz:oListaOrdenCompra )
                {
                    if(oCEOrdenCompraMatriz.toString().contains(TxtCliente.getText().toUpperCase()))
                    {
                         ArrayList oArrayList=new ArrayList();
                        oArrayList.add(oCEOrdenCompraMatriz.getFecha());
                        oArrayList.add(oCEOrdenCompraMatriz.getCodigo());
                        oArrayList.add(oCEOrdenCompraMatriz);
                        oArrayList.add(oCEOrdenCompraMatriz.getTipoComprobante());
                        oArrayList.add(oCEOrdenCompraMatriz.getMoneda());
                        oArrayList.add(CLRedondear.FormatearDosDigitos(oCEOrdenCompraMatriz.getTotalPagar()));
                        oArrayList.add(oCEOrdenCompraMatriz.getUltimoEstado());
...
public CEOrdenCompraMatriz getCEOrdenCompraMatriz()
{
...
private void SelecionarRegistro()
    {
        ...
        if(filSel!=-1){
        oCEOrdenCompraMatriz=(CEOrdenCompraMatriz)TblDato.getValueAt(filSel, 2);
        dispose();
    ...
    private List<CEOrdenCompraMatriz> listarCompras()
    {
...
//        {
//            return CCOrdenCompra.BuscarOrdenCompra(3, dato,1);
//        }
        if(tbBusqueda.getSelectedIndex()==1){
            return CCOrdenCompra.BuscarOCPorCodigo(dato);
                }
        ...
        if(tbBusqueda.getSelectedIndex()==2){
            ...
            if(id_proveedor!=-1)
            {
                return CCOrdenCompra.BuscarOCPorProveedor(id_proveedor);
            }
        }
        ...
        if(tbBusqueda.getSelectedIndex()==0)
        {
           ...
           return CCOrdenCompra.BusqAvanzadaOC(pFecha,id_Estado,id_TipoComp,pFechaFin);
            }
        }
        return null;
    ...
    private void filtrarTabla()
    {
        ...
        oListaOrdenCompra=listarCompras();
       limpiarTabla();
       if(oListaOrdenCompra!=null)
       {

                for(CEOrdenCompraMatriz vCEOrdenCompraMatriz:oListaOrdenCompra )
                {
                        ArrayList oArrayList=new ArrayList();
                        oArrayList.add(vCEOrdenCompraMatriz.getFecha());
                        oArrayList.add(vCEOrdenCompraMatriz.getCodigo());
                        oArrayList.add(vCEOrdenCompraMatriz);
                        oArrayList.add(vCEOrdenCompraMatriz.getTipoComprobante());
                        oArrayList.add(vCEOrdenCompraMatriz.getMoneda());
                        oArrayList.add(CLRedondear.FormatearDosDigitos(vCEOrdenCompraMatriz.getTotalPagar()));
                        oArrayList.add(vCEOrdenCompraMatriz.getUltimoEstado());
                        ((ArrayListTableModel)TblDato.getModel()).addRow(oArrayList);
