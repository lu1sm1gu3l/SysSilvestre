...
public class DlgBuscarRolComponenteAccion extends DialogoPadre implements ActionListener
{
    public DlgBuscarRolComponenteAccion(java.awt.Frame parent, boolean modal,String parametro)
    {
        super(parent, modal);
        initComponents();
    ...
    {
         TblResultados.getColumnModel().getColumn(0).setMaxWidth(280);
         TblResultados.getColumnModel().getColumn(0).setMinWidth(280);
    }
    ...
    public CERol getRol()
    {
        ...
        CERol oCERol=null;
        CEVinculacionRolComponenteAccionMatriz oCEVinculacionComponenteAccionMatriz=null;
        if(selectedRow!=-1)
        {

        oCERol=(CERol)TblResultados.getValueAt(selectedRow, 1);
        dispose();
        }
        return oCERol;
    }
    ...
    private void cargarTabla(List<CERol>  oVctRol)
    {
        limpiarTabla();
        ArrayList oList;
        if(oVctRol!=null)
        {
            int size=oVctRol.size();
            for(int a=0;a<size;a++)
            {
            oList=new ArrayList();
//            oList.add(oVctRol.get(a).getIdRol());

            oList.add(oVctRol.get(a).getNombre());
            oList.add(oVctRol.get(a));
            ...
            jPanel3Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(jPanel4, javax.swing.GroupLayout.Alignment.LEADING, 0, 577, Short.MAX_VALUE)
    ...
    private void buscarComponente()
    {
         String datoComponente=TxtComponente.getText().trim();
                ...
                CCRol oCCRol=new CCRol();
                List<CERol> oVctRol=oCCRol.consultarRol(datoComponente);
                cargarTabla(oVctRol);
