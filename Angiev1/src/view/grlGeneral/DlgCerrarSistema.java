...
public class DlgCerrarSistema extends DialogoPadre {

    private MiRelojHora hilo;

    public DlgCerrarSistema(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    if(!CCAtencionSistema.CerrarSistema())
    {
        JOptionPane.showMessageDialog(null,"No se pudo cerrar el sistema");
    }
    else
    {
        JOptionPane.showMessageDialog(null,"El sistema ya se encuentra cerrado");
        FrmSistemaMenu.setSiNoAtencion(3);
        dispose();
    }
