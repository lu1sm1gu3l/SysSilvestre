...
public class DlgBusquedaPedido extends DialogoPadre implements ActionListener
{

    private List<CEPedidoMatriz> oListaPedidoMatriz;
    private java.awt.Frame oparent;
    private boolean cargar;
    public DlgBusquedaPedido(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        cargar=false;
        ...
        CbxEstado.setModel(CLComboBox.cargarCombo(CCEstado.ListadoEstado(10)));
        this.oparent=parent;
        cargar=true;
        filtrarTabla();
    }
  ...
  ;
    ...
    private void initComponents() {
        ...
        jPanel3.add(DtChFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, 111, -1));
        ...
        jPanel3.add(TxtCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, 440, -1));

        lblCliente.setText("Cliente    :");
        jPanel3.add(lblCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, 70, -1));
        ...
        jPanel3.add(CbxEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 40, 161, -1));

        LblEstado.setText("Estado:");
        jPanel3.add(LblEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, -1, -1));
        ...
        jPanel3.add(CbxTipoComp, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, 190, -1));

        lblTipocomp.setText("Comprob :");
        jPanel3.add(lblTipocomp, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 40, -1, -1));
        ...
        jPanel3.add(DtChFechaFinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 111, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(tbBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 730, javax.swing.GroupLayout.PREFERRED_SIZE)
 ...
 boolean iscerrando=false;
    ...
    {
    limpiarTabla();
         for(CEPedidoMatriz pCEPedidoMatriz:oListaPedidoMatriz )
                {
                    if(pCEPedidoMatriz.toString().contains(TxtCliente.getText().toUpperCase()))
                    {
                         ArrayList oArrayList=new ArrayList();
                        oArrayList.add(pCEPedidoMatriz.getFecha());
                        oArrayList.add(pCEPedidoMatriz.getCodigo());
                        oArrayList.add(pCEPedidoMatriz);
                        oArrayList.add(pCEPedidoMatriz.getTipoComprobante());
                        oArrayList.add(pCEPedidoMatriz.getMoneda());
                        oArrayList.add(CLRedondear.FormatearDosDigitos(pCEPedidoMatriz.getTotalPagar()));
                        oArrayList.add(pCEPedidoMatriz.getUltimoEstado());
...
public CEPedidoMatriz getCEPedidoMatriz()
{
...
private void SelecionarRegistro()
    {
        ...
        if(filSel!=-1){
        oCEPedidoMatriz=(CEPedidoMatriz)TblDato.getValueAt(filSel, 2);
        dispose();
    ...
    private List<CEPedidoMatriz> listarRegistros()
    {
...
//        }
        ...
        if(tbBusqueda.getSelectedIndex()==2){
            ...
            if(id_Cliente!=-1)
            {
                return CCPedido.BuscarPedidoPorCliente(id_Cliente);
            }
        }
        ...
        if(tbBusqueda.getSelectedIndex()==0)
        {
           ...
           return CCPedido.BusqAvanzada(pFecha,id_Estado,oCETipoComprobante.getIdTipoComprobante(),pFechaFin);
            }
        }
        return null;
    ...
    {
       oListaPedidoMatriz=listarRegistros();
       limpiarTabla();
       if(oListaPedidoMatriz!=null)
       {
