...
public class DlgAnularPedido extends DialogoPadre
{

    CEPedidoMatriz oCEPedidoMatriz;
    public DlgAnularPedido(java.awt.Frame parent, boolean modal,CEPedidoMatriz oCEPedidoMatriz)
    {
        super(parent, modal);
        initComponents();
        this.oCEPedidoMatriz=oCEPedidoMatriz;
        TxtCliente.setText(oCEPedidoMatriz.getCliente());
        TxtNumPedido.setText(oCEPedidoMatriz.getCodigo());
    ...
    {
        long id=oCEPedidoMatriz.getIdPedido();
        CEPedidoMatriz oCEPedidoMatrizAux=CCPedido.ConsultarPedidosPorId(id);
        if(oCEPedidoMatrizAux.getIdUltimoEstado()!=1)
        {
            JOptionPane.showMessageDialog(this,"No se puede Realizar la operación, el pedido se encuentra "+ oCEPedidoMatrizAux.getUltimoEstado(),"Mensaje de Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    private void BtnAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAnularActionPerformed
     ...
     if(validar()){
         ...
         oCEPedidoMatriz.setObservacion(TxObservacion);
         if(CCPedido.AnularPedido(oCEPedidoMatriz)==1)
         {
            dispose();
         }
        else
