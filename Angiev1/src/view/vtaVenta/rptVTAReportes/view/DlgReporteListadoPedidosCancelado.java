...
public class DlgReporteListadoPedidosCancelado extends DialogoPadre
{
 
    public DlgReporteListadoPedidosCancelado(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String fecha1,String fecha2,String p1,String p2,String url)
    ...
    private void initComponents() {
        ...
        setTitle("Listado de Pedidos Cobrados");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(PnlMostrar, javax.swing.GroupLayout.DEFAULT_SIZE, 890, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
            ...
            public void run() {
                try {
                    ...
                    if(consultaId()==2)
                    {
                        ...
                        reportar(oCEConvertidorFecha.getFechaYMD(),fecha2,"pDel","pAl","/view/vtaVenta/rptVTAReportes/VTARPTPedidosCanceladosPorIntervalosFecha.jasper");

                    }
                    else
                    {
                    reportar(oCEConvertidorFecha.getFechaYMD(),null,"pFechaExacta","","/view/vtaVenta/rptVTAReportes/VTARPTPedidosCanceladosPorFechaExacta.jasper");
                    }
