...
import view.almAlmacen.invInventarios.*;
...
public class DlgRPTVentaProductosPorComp extends DialogoPadre
{

    java.awt.Frame parent;
    public DlgRPTVentaProductosPorComp(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
