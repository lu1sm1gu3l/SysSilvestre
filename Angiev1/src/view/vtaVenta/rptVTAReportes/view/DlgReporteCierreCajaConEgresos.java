...
public class DlgReporteCierreCajaConEgresos extends DialogoPadre
{
 
    public DlgReporteCierreCajaConEgresos(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        ...
        Runnable miRunnable = new Runnable() {
            public void run() {
                try {
                                ...
                                {
                                    oUrlRC=getClass().getResource("/view/vtaVenta/rptVTAReportes/VTARPTCierreCajaCabecera2.jasper");
                                }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(PnlMostrar, javax.swing.GroupLayout.DEFAULT_SIZE, 647, Short.MAX_VALUE)
                .addContainerGap())
        );
