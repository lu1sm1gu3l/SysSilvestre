...
public class DlgReporteListadoComprobanteCancelado extends DialogoPadre
{
 
    public DlgReporteListadoComprobanteCancelado(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String fecha1,String fecha2,String p1,String p2,String url)
    ...
    private void initComponents() {
        ...
        setTitle("Listado de Comprobantes Cancelados");
            ...
            public void run() {
                try {
                    ...
                    String fecha2=null;
                        ...
                        reportar(oCEConvertidorFecha.getFechaYMD(),fecha2,"pDel","pAl","/view/vtaVenta/rptVTAReportes/VTARPTComprobantesCancelados.jasper");
