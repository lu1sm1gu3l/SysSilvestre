...
public class DlgReporteSalidaAlmacen extends DialogoPadre
{
 
    public DlgReporteSalidaAlmacen(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String url)
    ...
    this.getparametros();
    ClaseReporte_Parametro oClaseParametropidventa = new ClaseReporte_Parametro();
    oClaseParametropidventa.setNombre("pidventa");
    oClaseParametropidventa.setPParametro(""+pidventa);
    ...
    oLstParametro.add(oClaseParametropidventa);
    ...
    private void initComponents() {
        ...
        setTitle("Reporte Resumen Salida de Producto");
        ...
        chkventa.setText("Ventas");

        chekdev.setSelected(true);
        chekdev.setText("devolución");
        ...
        chktransf.setText("Transferencia Almacen");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(chkventa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(chktransf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(63, 63, 63)
                        .addComponent(BtnGenerar))
                    .addComponent(chkajuste, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(PnlMostrar, javax.swing.GroupLayout.DEFAULT_SIZE, 1003, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addComponent(PnlMostrar, javax.swing.GroupLayout.PREFERRED_SIZE, 593, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap()))
        );
    ...
    private void BtnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGenerarActionPerformed
        ...
        if(!chkventa.isSelected()&&!chekdev.isSelected()&&!chkotros.isSelected()&&!chktransf.isSelected())
        {
            JOptionPane.showMessageDialog(null,"Seleccione al menos un tipo de Salida");
        }else{
        ...
        Runnable miRunnable = new Runnable() {
            public void run() {
                try {
                        ...
                        reportar("/view/almAlmacen/rptALMReportes/ALMRPTSalidaAlmacen.jasper");
    ...
    private Opcion.CheckBox chkventa;
