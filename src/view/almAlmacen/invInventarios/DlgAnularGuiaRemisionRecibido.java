...
public class DlgAnularGuiaRemisionRecibido extends DialogoPadre
{

    private CEGuiaRemisionRecibido oCEGuiaRemisionRecibido;
    private boolean isanulado;

    public DlgAnularGuiaRemisionRecibido(java.awt.Frame parent, boolean modal,CEGuiaRemisionRecibido oCEGuiaRemisionRecibido)
    {
        super(parent, modal);
        initComponents();
        isanulado=false;
        this.oCEGuiaRemisionRecibido=oCEGuiaRemisionRecibido;
        TxtCliente.setText(oCEGuiaRemisionRecibido.getProveedor()+"");
        TxtNumOrdenCompra.setText(oCEGuiaRemisionRecibido.getNumeroDocumento());
