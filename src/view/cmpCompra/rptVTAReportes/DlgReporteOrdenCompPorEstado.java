...
public class DlgReporteOrdenCompPorEstado extends DialogoPadre
{
 
    public DlgReporteOrdenCompPorEstado(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String url)
 ...
 ClaseReporte_Parametro oClaseParametroSucursal = new ClaseReporte_Parametro();
    ...
    private void initComponents() {
        ...
        setTitle("Reporte Oden de Compra");
        ...
        Runnable miRunnable = new Runnable() {
            public void run() {
                try {
                        ...
                        reportar("/view/cmpCompra/rptVTAReportes/VTARPTOrdenCompraPorEstado.jasper");
