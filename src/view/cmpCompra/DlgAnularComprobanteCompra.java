...
public class DlgAnularComprobanteCompra extends DialogoPadre
{

    CEComprobanteCompraMatriz oCEComprobanteCompraMatriz;
    public DlgAnularComprobanteCompra(java.awt.Frame parent, boolean modal,CEComprobanteCompraMatriz oCEComprobanteCompraMatriz)
    {
        super(parent, modal);
        initComponents();
        this.oCEComprobanteCompraMatriz=oCEComprobanteCompraMatriz;
        TxtCliente.setText(oCEComprobanteCompraMatriz.getProveedor()+"");
        TxtNumOrdenCompra.setText(oCEComprobanteCompraMatriz.getNumComprobante());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Anular Comprobante Compra");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(TxtObservacion, javax.swing.GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE))))
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void BtnAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAnularActionPerformed
     ...
     oCEComprobanteCompraMatriz.setObservacion(TxObservacion);
     Anulado=true;
     dispose();
