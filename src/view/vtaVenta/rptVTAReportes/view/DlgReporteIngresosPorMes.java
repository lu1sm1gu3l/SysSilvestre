...
public class DlgReporteIngresosPorMes extends DialogoPadre
{
 
    public DlgReporteIngresosPorMes(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String url)
    ...
    private void initComponents() {
        ...
        setTitle("Reporte Ingresos Mensuales");
        ...
        Runnable miRunnable = new Runnable() {
            public void run() {
                try {
                        ...
                        reportar("/view/vtaVenta/rptVTAReportes/VTARPTVentasPorMes.jasper");
