...
public class DlgReporteVentaClientePorProducto extends DialogoPadre
{

    private long idproducto=0;
    public DlgReporteVentaClientePorProducto(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String url)
    ...
    oClaseParametroCliente.setNombre("pidproducto");
    oClaseParametroCliente.setPParametro(""+idproducto);
    ...
    private void initComponents() {
        ...
        TxtProducto = new TextField.JTxtLetra();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(PnlMostrar, javax.swing.GroupLayout.DEFAULT_SIZE, 1123, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        Runnable miRunnable = new Runnable() {
            public void run() {
                try {
                        ...
                        reportar("/view/vtaVenta/rptVTAReportes/VTARPTVentasClientesPorProducto.jasper");
...
private void buscarProducto()
    {
        if(TxtProducto.isEnabled()){
            ...
            CEProducto oCEProducto=odialogo.getProductoAlmacen();

            if(oCEProducto!=null){
            TxtProducto.setText(oCEProducto.getDescripcion());
            idproducto=oCEProducto.getIdProducto();
            }
    ...
    private TextField.JTxtLetra TxtProducto;
