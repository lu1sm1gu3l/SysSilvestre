...
public class DlgReporteComprobante extends DialogoPadre
{
    private CEComprobanteVentaMatriz oCEComprobanteVentaMatriz;
 
    public DlgReporteComprobante(java.awt.Frame parent, boolean modal,CEComprobanteVentaMatriz pCEComprobanteVentaMatriz)
    {
        super(parent, modal);
        initComponents();
        this.oCEComprobanteVentaMatriz=pCEComprobanteVentaMatriz;
        reportar();
    }
        ...
        Runnable miRunnable = new Runnable() {
            public void run() {
                try {
                                ...
                                URL oUrlRC=null;
                                if(oCEComprobanteVentaMatriz.getTipoComprobante().equals("BOLETA"))
                                {
                                oUrlRC=getClass().getResource("/view/vtaVenta/rptVTAReportes/VTARPTComprobanteVenta.jasper");
                                }
                                else if(oCEComprobanteVentaMatriz.getTipoComprobante().equals("FACTURA"))
                                {
                                 oUrlRC=getClass().getResource("/view/vtaVenta/rptVTAReportes/VTARPTComprobanteVentaFT.jasper");
                                }
                                else
                                {
                                   oUrlRC=getClass().getResource("/view/vtaVenta/rptVTAReportes/VTARPTComprobanteVenta.jasper");
                                ...
                                oClaseParametroComp_Venta.setPParametro(oCEComprobanteVentaMatriz.getIdComprobanteVenta()+"");
                                ...
                                oClaseParametroNum.setPParametro(oParserNumerosALetras.Convertir(oCEComprobanteVentaMatriz.getMontoTotal()+"", true));
