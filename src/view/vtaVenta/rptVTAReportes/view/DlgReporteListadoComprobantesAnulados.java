...
public class DlgReporteListadoComprobantesAnulados extends DialogoPadre
{
 
    public DlgReporteListadoComprobantesAnulados(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
...
private void reportar(String fecha1,String fecha2,String p1,String p2,String url)
    ...
    private void initComponents() {
        ...
        setTitle("Listado de Comprobantes Anulados ");
            ...
            public void run() {
                try {
                    ...
                    if(consultaId()==2)
                    {
                        ...
                        reportar(oCEConvertidorFecha.getFechaYMD(),fecha2,"pDel","pAl","/view/vtaVenta/rptVTAReportes/VTARPTComprobantesAnuladosPorIntervalosFecha.jasper");

                    }
                    else
                    {
                    reportar(oCEConvertidorFecha.getFechaYMD(),null,"pFechaExacta","","/view/vtaVenta/rptVTAReportes/VTARPTComprobantesAnuladosPorFechaExacta.jasper");
                    }
