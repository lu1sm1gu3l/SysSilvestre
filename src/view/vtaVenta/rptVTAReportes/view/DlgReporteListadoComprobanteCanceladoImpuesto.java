...
public class DlgReporteListadoComprobanteCanceladoImpuesto extends DialogoPadre
{
 
    public DlgReporteListadoComprobanteCanceladoImpuesto(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        dchDe.setDate(FrmSistemaMenu.FechaSistema);
        dchA.setDate(FrmSistemaMenu.FechaSistema);
...
private void reportar(String fecha1,String fecha2,String p1,String p2,String url)
    ...
    private void initComponents() {
        ...
        setTitle("Listado de Comprobantes Cancelados Con Exonerado");
        ...
        RbtIntervalo.setText("Solo con Exonerado");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(PnlMostrar, javax.swing.GroupLayout.DEFAULT_SIZE, 1018, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
            ...
            public void run() {
                try {
                    ...
                    String fecha2=null;
                        ...
                        reportar(oCEConvertidorFecha.getFechaYMD(),fecha2,"pDel","pAl","/view/vtaVenta/rptVTAReportes/VTARPTComprobantesCanceladosImpuesto.jasper");
