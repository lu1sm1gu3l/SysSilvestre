 ...
 * @author Luiggi
 */
public class DlgCuadreCaja extends javax.swing.JDialog {
    private CECuadreCaja oCECuadreCaja;

    /** Creates new form DlgCuadreCaja */
    public DlgCuadreCaja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
private long ObtenerIdCuadreCajaDetalle(int idMoneda)
{
    ...
    private void initComponents() {
        ...
        TblCuadreCajaTipoPago.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nº", "Moneda", "Tipo Pago", "Monto Sistema", "Monto en Caja", "Monto Diferencia"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(LblFechaCuadre, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
                    .addComponent(LblfechaApertura, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(LblEstado, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE)
                        .addGap(2, 2, 2))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        TblCuadreCajaDetalle.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nº", "Moneda", "Monto Efectivo Inicial", "Monto Total Sistema", "Monto Total en Caja", "Monto Total Diferencia"
            }
        ) {
            Class[] types = new Class [] {
        ...
        TblCuadreCajaDetalle.getColumnModel().getColumn(1).setPreferredWidth(110);
        TblCuadreCajaDetalle.getColumnModel().getColumn(2).setResizable(false);
        TblCuadreCajaDetalle.getColumnModel().getColumn(2).setPreferredWidth(110);
        TblCuadreCajaDetalle.getColumnModel().getColumn(3).setResizable(false);
        TblCuadreCajaDetalle.getColumnModel().getColumn(3).setPreferredWidth(100);
        ...
        label6.setText("[MONTOS TOTALES]");

        label7.setText("[MONTOS POR TIPO DE PAGO]");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(125, 125, 125)
                    .addComponent(PnlBotones, javax.swing.GroupLayout.PREFERRED_SIZE, 411, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private boolean validar()
    {
        for(int i=0; i< TblCuadreCajaTipoPago.getRowCount();i++)
        {
            float montoCaja=VerificadorDeTxt.convertFloat(TblCuadreCajaDetalle.getValueAt(i, 1));
            if(montoCaja==0)
            {

                JOptionPane.showMessageDialog(null,"Ingrese el Monto en Caja");
                 TblCuadreCajaTipoPago.requestFocus();
                TblCuadreCajaTipoPago.changeSelection(i, 4, false, false);
                return false;
            }
        }
