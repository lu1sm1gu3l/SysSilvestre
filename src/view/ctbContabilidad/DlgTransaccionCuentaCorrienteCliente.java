...
public class DlgTransaccionCuentaCorrienteCliente extends DialogoPadre{
    private CECuentaCorrienteCliente oCECuentaCorriente;
    public DlgTransaccionCuentaCorrienteCliente(java.awt.Frame parent, boolean modal,CECuentaCorrienteCliente oCECuentaCorriente) {
        super(parent, modal);
        initComponents();
    ...
    {
        limpiarTabla();
        LblCliente.setText(oCECuentaCorriente.getCliente());
        ...
        int i=0;
        for(CEMovimientoCuentaCliente oCEMovimientoCuenta:oCECuentaCorriente.getoLstMovimientoCuenta())
        {
    ...
    private void initComponents() {
        ...
        LblCliente.setFont(new java.awt.Font("Verdana", 0, 12));
        LblCliente.setText("------------------------------------------------------------------");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(LblCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE))
        ...
        BtnDeposito.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(BtnDeposito, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)
                            .addComponent(BtnRetiro, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)))
    ...
    private void BtnDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDepositoActionPerformed
     DlgDepositoCuentaCorrienteCliente oDlgDepositoCuentaCorriente=new DlgDepositoCuentaCorrienteCliente(null,true,oCECuentaCorriente);
     oDlgDepositoCuentaCorriente.setLocationRelativeTo(null);
     oDlgDepositoCuentaCorriente.setVisible(true);
     this.oCECuentaCorriente=CCCuentaCorrienteCliente.consultarCuentaCorrientePorClienteConDetalle(oCECuentaCorriente.getIdCliente(),oCECuentaCorriente.getIdMoneda());
     cargarCuentaCorriente();
    }//GEN-LAST:event_BtnDepositoActionPerformed

    private void BtnRetiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRetiroActionPerformed
     DlgRetiroCuentaCorrienteCliente oDlgDepositoCuentaCorriente=new DlgRetiroCuentaCorrienteCliente(null,true,oCECuentaCorriente);
     oDlgDepositoCuentaCorriente.setLocationRelativeTo(null);
     oDlgDepositoCuentaCorriente.setVisible(true);
     this.oCECuentaCorriente=CCCuentaCorrienteCliente.consultarCuentaCorrientePorClienteConDetalle(oCECuentaCorriente.getIdCliente(),oCECuentaCorriente.getIdMoneda());
     cargarCuentaCorriente();
